...
export default function Services() {
  const whatsappUrl =
    "https://wa.me/555199555-3535?text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20os%20serviços%20da%20Pet%20Moleque."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="space-y-16">
            {servicesDetail.map((service, index) => {
              ...
              const serviceWhatsappUrl = `https://wa.me/555199555-3535?text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20o%20serviço%20de%20${encodeURIComponent(service.title)}%20da%20Pet%20Moleque.`
          ...
          <div className="mt-20 bg-gradient-to-br from-white to-[#F5F1E8] p-10 rounded-2xl shadow-xl border-2 border-[#E6E0D2]">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="https://wa.me/555199555-3535?text=Olá!%20Tenho%20algumas%20dúvidas%20sobre%20os%20serviços%20da%20Pet%20Moleque."
                  target="_blank"
                  rel="noopener noreferrer"
